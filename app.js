<!-- index.html（差分は見た目のみ：app.jsが自動でスコア表示を追加するため、HTML変更は必須ではありません）
     ただし、試合一覧の説明文を「対戦チーム vs 対戦チーム」前提に軽く更新しています。 -->
...
<body>
  ...
  <section id="admin-section" style="display:none;">
    ...
    <p class="hint">試合名は「A vs B」形式で入力してください（試合一覧表示に使用します）。</p>
  ...
  <section id="matches-section" style="display:none;">
    ...
    <p class="hint">表示は「対戦チーム vs 対戦チーム」形式です。試合をクリックすると入室します。</p>
  </section>
